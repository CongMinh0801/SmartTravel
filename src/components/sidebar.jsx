...
function Sidebar() {
    ...
    useEffect(() => {
        ...
        setFixed(window.innerWidth < 1024);
        const handleResize = () => {
            setOpen(window.innerWidth > 1024);
            setFixed(window.innerWidth < 1024);
        };
    ...
    return (
        <div
            className={`bg-white border-r min-h-screen ${open ? 'w-72' : 'w-16'} ${
                fixed ? 'fixed top-0 left-0 z-10' : ''
            } shadow-lg side-bar flex-none`}
        >
            <div
                className={`w-full p-2 flex ${open ? 'justify-between' : 'justify-center'} items-center transition-all`}
                style={{ height: '72px' }}
            >
                <Image
                    src="/logo_brand.png"
                    ...
                    height={72}
                />
                <span className={`text-xl text-sky-400 font-bold ${open ? 'block' : 'hidden'}`}>SmartTravel</span>
            ...
            <div className="mt-2">
                ...
                <div
                    className={`${
                        ...
                        selected == 'quan-ly-dat-cho' || selected == 'quan-ly-ve' ? 'bg-sky-100 text-sky-400' : ''
                    } text-gray-500`}
                >
                    ...
                    <div className="hover:bg-white hover:text-gray-500 relative">
                        ...
                        <div className={`absolute left-full -top-12 w-[200px] z-10 shadow-xl border show-quan-ly-list`}>
                            <button
                                onClick={() => setSelected('quan-ly-dat-cho')}
